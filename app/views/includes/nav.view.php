      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <?php else: ?>
            ...
            <li class="dropdown"><a href="category"><span>Hy, <?=Auth::getFirstname()?> </span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="<?=ROOT?>/admin">Dashboard</a></li>
              <li><a href="search-result">Profile</a></li>
