                ...
                <div class="card-body">
                  ...
                  <form method="POST" class="row g-3 needs-validation" novalidate>
                    <div class="col-6">
                      ...
                      <input value="<?= set_value('firstname') ?>" type="text" name="firstname" class="form-control <?=!empty($errors['firstname']) ? 'border-danger' : ''; ?>" id="yourName" requiredqqqqq>
                    ...
                    <div class="col-6">
                      ...
                      <input value="<?= set_value('lastname') ?>" type="text" name="lastname" class="form-control <?=!empty($errors['lastname']) ? 'border-danger' : ''; ?>" id="yourName2" requiredqqqqq>
                    ...
                    <div class="col-12">
                      ...
                      <input value="<?= set_value('email') ?>" type="email" name="email" class="form-control <?=!empty($errors['email']) ? 'border-danger' : ''; ?>" id="yourEmail" requiredqqqqq>
                    ...
                    <div class="col-12">
                      ...
                      <input value="<?= set_value('password') ?>" type="password" name="password" class="form-control <?=!empty($errors['password']) ? 'border-danger' : ''; ?>" id="yourPassword" requiredqqqqq>
                    ...
                    <div class="col-12">
                      ...
                      <input value="<?= set_value('retype_password') ?>" type="password" name="retype_password" class="form-control <?=!empty($errors['retype_password']) ? 'border-danger' : ''; ?>" id="yourPassword" requiredqqqqq>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        <input <?= set_value('terms') ? 'checked' : '' ; ?> class="form-check-input <?=!empty($errors['terms']) ? 'border-danger' : ''; ?>" name="terms" type="checkbox" value="1" id="acceptTerms" requiredqqqqq>
